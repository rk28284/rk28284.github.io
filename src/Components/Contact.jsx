...
const Contact = () => {
  return (
    ...
    <FormControl as="form" action="https://getform.io/f/67c67ee3-5564-4501-bd17-7ff4ad2466d5" method="POST" style={{width:"40%",textAlign:"center"}}>
    ...
    <div style={{ display: "flex", justifyContent: "center", flexDirection: "row", width:"50%", gap:"2%",marginTop:"10px" }}>
          <a 
          href="rk28284@gmail.com" >
             <>
            <HiOutlineMail size={60}/>
             </>
          </a>
          <a 
          href='https://www.linkedin.com/in/rakesh-kumar-b60317125/'
